...
int main(){
    ...
    densidade_populacional1 = (float) (numero_habitantes1 / area1);
    // densidade_populacional2 = (float) (numero_habitantes2 / area2);

    //? Cálculo do PIB per capita
    pib_per_capita1 = (pib1 * 1000000000.0f) / numero_habitantes1;
    // pib_per_capita2 = (pib2 * 1000000000.0f) / numero_habitantes2;
